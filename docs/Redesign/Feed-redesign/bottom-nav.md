...
export const TabBar = () => {
  return (
    <div className="flex w-[415px] h-[88px] items-center justify-between pt-4 pb-8 px-7 relative">
      <div className="inline-flex items-center relative flex-[0_0_auto] mt-[-7.00px] mb-[-7.00px]">
        <LiquidGlassRegular
          blur="blur-2.svg"
        ...
        <div className="flex flex-col w-[102px] items-center justify-center gap-px pt-1.5 pb-[7px] px-2 relative -ml-2.5">
          <div className="flex h-7 items-center justify-center gap-2.5 relative self-stretch w-full">
            <Camera className="!relative !w-6 !h-6" />
          </div>

          <div className="relative self-stretch [font-family:'SF_Pro-Medium',Helvetica] font-medium text-neutral-700 text-[10px] text-center tracking-[0] leading-3">
            Camera
          </div>
        </div>
      </div>

      <div className="inline-flex items-center relative flex-[0_0_auto] mt-[-4.00px] mb-[-4.00px]">
        ...
        <div className="relative w-12 h-12 -ml-2.5">
          <img
            className="absolute top-[calc(50.00%_-_17px)] left-[calc(50.00%_-_17px)] w-[34px] h-[34px]"
            alt="Icon"
            src={icon}
          />
        </div>
