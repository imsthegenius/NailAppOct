-- ============================================================================
-- Insert 2025 Trending Colors
-- File: 28_insert_2025_trending_colors.sql
-- Purpose: Add 100 most popular colors of 2025 with proper categorization
-- ============================================================================

-- Step 1: Drop constraint to allow inserts
ALTER TABLE colors DROP CONSTRAINT IF EXISTS colors_category_check;

-- Step 2: Insert all 100 trending colors
INSERT INTO colors (hex_code, name, brand, category, finish, trending_score, season, mood_tags, pantone_code) VALUES
-- Milky & Pearl Colors
('#F2F0ED', 'Milky Sheer', 'Trending 2025', 'nudes', 'sheer', 95, ARRAY['spring', 'summer', 'fall', 'winter'], ARRAY['milky', 'sheer', 'clean'], 'Trending-001'),
('#F7F3EF', 'Glazed Donut Pearl', 'Trending 2025', 'french', 'pearl', 98, ARRAY['spring', 'summer', 'fall', 'winter'], ARRAY['pearl', 'glazed', 'donut'], 'Trending-002'),

-- Jelly Colors
('#FF8FB3', 'Jelly Pink', 'Trending 2025', 'pinks', 'jelly', 96, ARRAY['spring', 'summer'], ARRAY['jelly', 'pink', 'translucent'], 'Trending-003'),
('#E34153', 'Jelly Cherry', 'Trending 2025', 'reds', 'jelly', 94, ARRAY['spring', 'summer'], ARRAY['jelly', 'cherry', 'red'], 'Trending-004'),
('#FFA45C', 'Jelly Tangerine', 'Trending 2025', 'pastels', 'jelly', 93, ARRAY['spring', 'summer'], ARRAY['jelly', 'tangerine', 'orange'], 'Trending-005'),
('#E9C8FF', 'Jelly Lilac', 'Trending 2025', 'purples', 'jelly', 95, ARRAY['spring', 'summer'], ARRAY['jelly', 'lilac', 'purple'], 'Trending-006'),
('#355CFF', 'Jelly Ultramarine', 'Trending 2025', 'blues', 'jelly', 92, ARRAY['spring', 'summer'], ARRAY['jelly', 'ultramarine', 'blue'], 'Trending-007'),
...
('#B76E79', 'Rose Gold', 'Trending 2025', 'metallics', 'metallic', 96, ARRAY['all seasons'], ARRAY['rose', 'gold', 'metallic'], 'Trending-026'),
...
('#FAF3E7', 'Vanilla Sheer', 'Trending 2025', 'nudes', 'sheer', 95, ARRAY['spring', 'summer'], ARRAY['vanilla', 'sheer', 'soft'], 'Trending-032'),
...
('#E0F2FF', 'Icy Blue Sheer', 'Trending 2025', 'pastels', 'sheer', 93, ARRAY['winter'], ARRAY['icy', 'blue', 'sheer'], 'Trending-063'),
...
('#6F42C1', 'Grape Jelly', 'Trending 2025', 'purples', 'jelly', 92, ARRAY['spring', 'summer'], ARRAY['grape', 'jelly', 'purple'], 'Trending-069'),
...
('#AD6F3B', 'Copper Penny', 'Trending 2025', 'metallics', 'matte', 92, ARRAY['fall', 'winter'], ARRAY['copper', 'penny', 'metallic'], 'Trending-086'),
...
-- Show some of the new trending colors
SELECT name, hex_code, category
FROM colors
WHERE name LIKE '%Trending 2025%'
...
BEGIN
    ...
    RAISE NOTICE 'Colors categorized into: nudes, reds, burgundy, pastels, french, blues, greens, purples, pinks, metallics, darks';
    RAISE NOTICE 'Total colors in database now updated';
END $$;